<template>
  <div @click.stop class="zillow-card group bg-white rounded shadow border border-gray-100 overflow-hidden flex flex-col" style="height:282px; width:307px; font-family: 'Roboto', Arial, sans-serif;">
    <!-- Imagen principal -->
